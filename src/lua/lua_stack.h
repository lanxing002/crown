...
#define PY_VECTOR3_MARKER_MASK     uintptr_t(0x03)
#define PY_VECTOR3_MARKER_SHIFT    uintptr_t(0)
#define PY_QUATERNION_MARKER_MASK  uintptr_t(0x0f)
#define PY_QUATERNION_MARKER_SHIFT uintptr_t(0)
#define PY_MATRIX4X4_MARKER_MASK   uintptr_t(0x3f)
#define PY_MATRIX4X4_MARKER_SHIFT  uintptr_t(0)
//
//namespace crown
//{
